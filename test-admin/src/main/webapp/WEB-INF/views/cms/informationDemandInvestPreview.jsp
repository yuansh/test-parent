	...
	<div>
		...
		<div class="hero-unit">
			<form id="form" name="form">
				...
				<div>
					<label style="display:inline-block; width:200px; text-align:left; margin-right:10px;" for="rate">年化利率范围：${informationDemand.investment.rateLow} - ${informationDemand.investment.rateHigh}（%）</label>
					<label style="display:inline-block; width:600px; text-align:left; margin-right:10px;" for="raising">募资能力：${informationDemand.investment.raisingLow} - ${informationDemand.investment.raisingHigh}（元）</label> 
				</div>
				<div>
					<label style="display:inline-block; width:200px; text-align:left; margin-right:10px;" for="deadline">希望期限：${informationDemand.investment.deadlineLow} - ${informationDemand.investment.deadlineHigh}（月）</label> 
					<label style="display:inline-block; width:200px; text-align:left; margin-right:10px;" for="raising"></label>
				</div>
				<div>
					<label style="display:inline-block; width:400px; text-align:left; margin-right:10px;" for="email">联系方式：${informationDemand.investment.contact}</label>
					<label style="display:inline-block; width:200px; text-align:left; margin-right:10px;" for="raising"></label>
				</div>
				<div>
					<table>
						<tr>
							...
							<td><textarea class="fl" style="line-height:40px;" disabled="disabled">${informationDemand.investment.description}</textarea></td>
						</tr>
					</table>
				</div>
				<div>
					...
					<!-- &nbsp;&nbsp;&nbsp;<a id="cancel" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="window.location.href='${ctx}/informationDemand/informationDemandManage'">返回</a> -->
				</div>
